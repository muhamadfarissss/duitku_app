<x-app-layout>
        ...
        <div class="bg-white w-full max-w-lg rounded-3xl p-8 border border-slate-200 shadow-xl">
            ...
            <form id="formTransaksi" onsubmit="addTransaction(event)" class="space-y-4">
                ...
                <div>
                    ...
                    <input id="kategori" type="text" placeholder="Contoh: Makanan & Minuman" required class="w-full bg-white border border-gray-300 rounded-xl py-3 px-4 text-sm shadow-sm focus:ring-2 focus:ring-[#0061cc] outline-none">
                </div>
    ...
    <script>
        ...
        function loadTransactions() {
            ...
            .then(data => {
                if(data.status === 'success') {
                    // Karena backend memanggil paginate(10), data aslinya ada di data.data.data
        ...
        function addTransaction(e) {
            ...
            // Ambil CSRF Token dari tag meta di layout app.blade.php
            ...
            .then(data => {
                if(data.status === 'success') {
                    closeModal();
                    loadTransactions(); // Otomatis refresh tabel setelah simpan berhasil!
                } else {
        ...
        function deleteTransaction(id) {
            ...
            .then(data => {
                if(data.status === 'success') {
                    loadTransactions(); // Refresh otomatis setelah dihapus
                }
            });
        }
