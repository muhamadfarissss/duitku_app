        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0 h-full overflow-y-auto">
            <div>
                ...
                <nav class="px-5 mt-2 space-y-2">
                    ...
                    <!-- Menu AI Quick Input -->
                    <a href="{{ route('ai.input') }}" 
                        class="flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-colors
                        {{ request()->routeIs('ai.input') ? 'bg-[#0061cc] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100' }}">
                    ...
                    <!-- Menu AI Insight -->
                    <a href="{{ route('ai.insight') }}" 
                        class="flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-colors
                        {{ request()->routeIs('ai.insight') ? 'bg-[#0061cc] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100' }}">
